...
class MainActivityHard : AppCompatActivity() {
...
// Construct the string to display all scores
        ...
        object : CountDownTimer(10000, 1000) {
            ...
            override fun onFinish() {
                ...
                val dialog = Dialog(this@MainActivityHard)  // Create a Dialog instance
            ...
            private fun navigateToScoresActivity(highScore:Int,currentScore: Int, allScoresList: MutableList<Int>) {
                val intent = Intent(this@MainActivityHard, LastActivity::class.java)
